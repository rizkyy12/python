...
dev1 = Employee('Sabrina Nurul N','sabrinanuruln', 50000)
dev2 = Developer('Rizky Andhika Akbar','rizkyandikaakbar', 100000, 'Software Engineer')
dev3 = Developer('Farhan Al','farhanal', 200000, 'Manufacture Engineer')
dev4 = Developer('Billy Ihsan','billyhaugh', 300000, 'Design Engineer')
